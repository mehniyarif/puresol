export default {
    methods: {
        ...
        // ONLY SECTION METHODS
        // ONLY SECTION METHODS
        insertSectionPlaceholder(currentSection, position = "before") {
            ...
            placeholderSection.addEventListener("dragover", (evt) => {
                evt.preventDefault();
                this.onDragOver(evt)
            })
            placeholderSection.addEventListener("dragenter", (evt) => {
                evt.preventDefault()
            })
            ...
            placeholderSection.addEventListener("dragleave", (evt) => {
                evt.target.remove()
            })
        ...
        onDragOverSection(evt) {
            ...
            if (currentSection instanceof HTMLElement) {
                ...
                this.insertSectionPlaceholder(currentSection, evt.x >= medianLine ? "after" : "before")
        ...
        // ONLY TASK METHODS
        // ONLY TASK METHODS
        insertTaskPlaceholder(currentTask, position = "before") {
            ...
            placeholderTask.addEventListener("dragleave", (evt) => {
                evt.target.remove()
            })
        ...
        onDragOverTask(evt) {
            ...
            if (!this.sections[currentSectionKey].tasks.length) {
                this.insertTaskPlaceholder(currentSectionKey)
            }
            ...
            if (currentTask instanceof HTMLElement) {
                ...
                this.insertTaskPlaceholder(currentTask, evt.clientY >= medianLine ? "after" : "before")
        ...
        onDragLeaveTask(evt) {
            ...
            if (!currentTask instanceof HTMLElement && this.taskOverElement) {
                    document.getElementById("task-wrapper-placeholder-id")?.remove()
            }
